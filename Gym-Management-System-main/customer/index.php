    ...
    <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="#">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><button type="submit" name="login" class="btn btn-success"\>User Login</button></span>
                </div>
                <div class="g">
                ...
                <br>
                    ...
                    <div class="controls">
                        ...
                        <div class="controls">
                            ...
                            <option selected="true" disabled="disabled">Preferences</option>
                                <option value="Fitness" >Weight Loss</option>
                                <option value="Sauna">Weight Gain</option>
                                <option value="Cardio">Yoga</option>
                                <option value="Pilates">Six Pack Abs</option>
                                <option value="Zumba">Regular Exercise</option>
                            </select>
                            </div>
                        </div>
