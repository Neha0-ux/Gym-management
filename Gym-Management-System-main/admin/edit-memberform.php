            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <label>
                  ...
                  <label>
                  <input type="radio" value="Pilates" name="services" />
                  Pilates <small>- $30 per month</small></label>
                  <label>
                  <input type="radio" value="Zumba" name="services" />
                  Zumba <small>- $25 per month</small></label>
              </div>
            </div>
